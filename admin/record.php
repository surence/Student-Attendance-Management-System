	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right">Student Attendance Record System</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				...
				<li class = "active"><a href = "record.php"><span class = "glyphicon glyphicon-book"></span> Attendace List (Record)</a></li>
			</ul>
			<br />
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; Student Attendance Record System 2025</label>
				<label class = "pull-right">Developer: Dev Champs</a></label>
			</div>	
		</div>	
	</body>
